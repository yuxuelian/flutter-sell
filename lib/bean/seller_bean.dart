...
class SellerBean {
  ...
  factory SellerBean(jsonStr) => jsonStr == null
      ? null
      : jsonStr is String
          ? new SellerBean.fromJson(json.decode(jsonStr))
          : new SellerBean.fromJson(jsonStr);
  ...
  SellerBean.fromJson(jsonRes) {
    ...
    for (var supportsItem in supports == null ? [] : jsonRes['supports']) {
      supports.add(
          supportsItem == null ? null : new Supports.fromJson(supportsItem));
    }
  }
